The file `HH_plane.txt` is provided to verify the computations included in the article "Postulation of lines in P^3 revisited", compatible with SINGULAR version 4.4.0.
